...
bool InitializeASIC(unsigned long handle, unsigned char slctMACIEs, short mode)
{
	...
	const char *filename = (mode != 0) ? "/home/dcss/macie_v5.3_centos/LoadFiles/msac/MACIE_Registers_Slow.mrf" :
										"/home/dcss/macie_v5.3_centos/LoadFiles/msac/MACIE_Registers_Slow.mrf";
	...
	const char *ASICFile0 = "/home/dcss/macie_v5.3_centos/LoadFiles/msac/HxRG_Main_hi230802.mcd";
...
bool Acquire_SlowMode(unsigned long handle, unsigned char slctMACIEs, unsigned char slctASIC)
{
	...
	unsigned int preampInputScheme = 1, preampInputVal = 0x4502, preampGain = 8;
	//unsigned int preampInputScheme = 2, preampInputVal = 0x4502, preampGain = 1;
	...
	MACIE_STATUS r6 = MACIE_WriteASICReg(handle, slctASIC, 0x4018, 0, true); 
	...
	char fileName[] = "/home/dcss/macie_v5.3_centos/examplecode/testImage_full.fits";
